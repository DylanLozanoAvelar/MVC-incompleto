    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<input type="text" name="idBomba" id="idBomba" style="display: none;">
		  <div class="input-group">
		    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		    <input id="tipoBomba" type="text" class="form-control" name="tipoBomba" placeholder="Nombres" required autocomplete="off">
		  </div>
		  <br>
		  <div class="input-group">
		    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		    <input id="tipoCombustible" type="text" class="form-control" name="tipoCombustibles" placeholder="Apellidos" required autocomplete="off">
		  </div>
		  <br>
		  <div class="input-group">
		    <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
		    <input id="estado" type="text" class="form-control" name="estado" placeholder="Correo electronico" required autocomplete="off">
		  </div>		  
      </div>
      <div class="modal-footer">
